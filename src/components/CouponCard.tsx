...
export default function CouponCard({ coupon }: CouponCardProps) {
  ...
  return (
    <>
      <div 
        className="relative bg-white rounded-lg overflow-hidden group hover:scale-[1.02] transition-transform duration-200 cursor-pointer"
      ...
      >
        ...
        <div className="p-4 border-2 border-dashed border-gray-200 m-3 rounded-lg">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Botão de Ativar */}
            <div
              className="flex-shrink-0 bg-gradient-to-br from-blue-600 to-blue-700 text-white font-bold px-6 py-3 rounded-lg transition-all duration-200 flex items-center gap-2 shadow-lg group-hover:shadow-xl group-hover:-translate-y-0.5 text-sm whitespace-nowrap"
            >
